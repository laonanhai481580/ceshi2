...
<head>
	...
	<script type="text/javascript">
		...
		function createTable(params){
			...
			var url = "${iqcctx}/inspection-statistics/part-unquality-item-table.htm";
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="myPartUnqualityItem";
	</script>
