...
<head>
	...
	function click(cellvalue, options, rowObject){	
		return "<a href='${iqcctx}/experimental-delegation/input.htm?id="+rowObject.id+"'>"+cellvalue+"</a>";
	}
	
	function create(){
		window.location.href='${iqcctx}/experimental-delegation/input.htm';
	}
	...
	function _viewProcessInfo(formId){
		$.colorbox({href:'${iqcctx}/experimental-delegation/view-info.htm?id='+formId,iframe:true,
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_experimental_delegation_list";
	</script>
		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn" id="btnDiv">
					<security:authorize ifAnyGranted="experimental-delegation-input">
						<button class='btn' type="button" onclick="create();"><span><span><b class="btn-icons btn-icons-add"></b>新建</span></span></button>
					</security:authorize>
					<security:authorize ifAnyGranted="experimental-delegation-delete">
					...
					<security:authorize ifAnyGranted="experimental-delegation-list-export">
						<button class='btn' type="button"  onclick="iMatrix.export_Data('${iqcctx}/experimental-delegation/export.htm');"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
				</div>
				<div id="opt-content">
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="dynamicInspection"  url="${iqcctx}/experimental-delegation/list-datas.htm" code="IQC_EXPERIMENTAL_DELEGATION" pageName="page"></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
