...
// 			$("#structure-tree").width(height-65);
			//左边的宽度
			var leftWidth = 160;
...
//	 				"initially_select" : [ "root"]
		...
		function createLeftBom(){
			var colModel = [
		   		...
		   		{label:'检验方法',name:'itemMethod',index:'itemMethod', width:120},
			...
			$("#leftInspectingItemList").jqGrid({
				...
				url:'${iqcctx}/inspection-base/item/list-datas.htm?',
				prmNames:{
					rows:'page.pageSize',
					page:'page.pageNo',
					sort:'page.orderBy',
	...
	<table>
		<tr>
			<td class="left" valign="top">
				<div id="left-tabs">
					<ul>
						<li><a href="#left-tabs-1">所有检验项目</a></li>
					</ul>
