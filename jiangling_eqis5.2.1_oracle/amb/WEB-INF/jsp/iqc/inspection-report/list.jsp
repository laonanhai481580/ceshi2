...
<%--  					<security:authorize ifAnyGranted="iqc-file-delete">  --%>
<!-- 						<button class='btn' type="button" id="_task_button" onclick='showIdentifiersDiv("flag","_task_button");'><span><span><b class="btn-icons btn-icons-delete"></b>导入附件删除</span></span></button> -->
<%--  					</security:authorize>  --%>
					...
					<button class='btn' type="button"  onclick="updateReWrite();"><span><span><b class="btn-icons btn-icons-export"></b>更新</span></span></button>
				</div>
				<div id="opt-content">
