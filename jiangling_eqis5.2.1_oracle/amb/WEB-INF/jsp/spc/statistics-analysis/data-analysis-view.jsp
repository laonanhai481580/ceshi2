	...
	<script type="text/javascript">
		...
		function search(){
			...
			if(date1>date2){
				...
				$.showMessage("质量分析统计中,请稍候...");//,"custom"
				setImgUrl();
			}
		}
		...
		<div class="opt-body" style="height: 100%;" >
			<form id="contentForm" name="contentForm" method="post" action="">
				<table class="form-table-outside-border" style="width:100%;display:block;" id="searchTable">
						...
						<td style="padding-left:6px;padding-bottom:4px;">
							<ul id="searchUl">
						 		<li>
						 			...
						 			<input id="datepicker1" type="text" readonly="readonly" style="width:68px" name="startDate_ge_date" value="<%=startDateStr%>"/>至<input id="datepicker2" type="text" readonly="readonly" style="width:68px" name="endDate_le_date" value="<%=endDateStr%>"/>
						 		</li>
						 		<li>
						 			<span class="label">质量特性</span>
						 			<s:select id="_qualityFeature" list="qualityFeatures" theme="simple" listKey="value" listValue="name" name="qualityFeatures"></s:select>
						 		</li>
						 		<li>
				 ...
				 <div style="display:block;color:red; font-weight:bold;" id="message"><s:actionmessage theme="mytheme" cssStyle="color:red;" /></div>
