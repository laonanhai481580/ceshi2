	...
	<script type="text/javascript">
		...
		function createBom(){
			$("#defectionCodeList").jqGrid({
				url:'${sictx}/base-info/defection-code/code-list-datas.htm',
				...
				multiselect: true,
				pager: '#pager',
				colNames:['','不良项目代码', '不良项目名称', '不良类别代码','不良类别名称'],
				colModel:[
		            ...
		            {name:'defectionTypeNo', index:'defectionTypeNo', width: 150,align:'left',editable:false},
					...
					<table class="form-table-outside-border" style="width:100%;">
						<tr>
							<td style="padding-left:6px;padding-bottom:4px;">
					 			<span class="field-label">项目代码</span>
					 			...
					 			<button class='btn' onclick="javascript:search();contentResize();"><span><span><b class="btn-icons btn-icons-find"></b>查询</span></span></button>
