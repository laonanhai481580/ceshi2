			...
			<div id="opt-content">
				...
				<form id="form" name="form"
					...
					<fieldset style="margin-top:4px;">
						...
						<textarea rows="8" style="width:98%;" name="initCompleteMethod">${initCompleteMethod}</textarea>
						<div>}</div>
					</fieldset>
					<fieldset style="margin-top:4px;">
						<legend>数据加载完成后的事件</legend>
						<div style="font-weight:bold;">function $loadComplete(gridId){</div>
						<textarea rows="8" style="width:98%;" name="loadCompleteMethod">${loadCompleteMethod}</textarea>
						<div>}</div>
					</fieldset>
				</form>
			</div>
