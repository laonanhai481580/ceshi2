	...
	function initDataColumnSet(){
		...
		$("#table").jqGrid({
			...
			colModel: [
				...
				{name:'fieldType',index:'fieldType',width:100,label:'字段类型',editable:true,edittype:'select',editrules:{required:true},editoptions:{value:dataTypeStr}},
				${customModelStr}
				{name:'searchType',index:'searchType',width:100,label:'查询方式',editable:true,edittype:'select',editrules:{required:true},editoptions:{value:'equals:等于;include:包含;leftequals:左包含;rightequals:右包含;notinclude:不包含;gt:大于;ge:大于等于;lt:小于;le:小于等于;between:范围内'}},
				{name:'defaultValue',index:'defaultValue',width:100,label:'默认值',editable:true,edittype:'select',editoptions:{value:defualtValues}},
