...
<head>
	...
	<script type="text/javascript">
		...
		function editInfo(isEdit,isCopy){
			...
			var url = '${chartdesignctx}/list-definition/input.htm?id='+id;
			if(isCopy){
				url += '&isCopy=true';
			}
			$.colorbox({
		...
		function showViewGrid(id){
			var url = '${chartdesignctx}/list-definition/view-grid.htm?id='+id;
			$.colorbox({
				href:url,
				iframe:true, 
				width:$(window).width()<800?$(window).width()-100:800, 
		...
		function import_Data(){
	 		var url = '${chartdesignctx}/list-definition/import-form.htm';
			$.colorbox({
				href:url,
				iframe:true, 
		...
		function exportGrid(){
			...
			var url = '${chartdesignctx}/list-definition/exports.htm';
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_list_definition";
	</script>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			<div class="opt-btn">
				<security:authorize ifAnyGranted="CHARTDESIGN-LISTVIEW-INPUT">
				...
				<security:authorize ifAnyGranted="CHARTDESIGN-LISTVIEW-DELETE">
				<button class='btn' onclick="iMatrix.delRow();"><span><span><b class="btn-icons btn-icons-delete"></b>删除</span></span></button>
				</security:authorize>
				<security:authorize ifAnyGranted="CHARTDESIGN-LISTVIEW-IMPORT">
				...
				<security:authorize ifAnyGranted="CHARTDESIGN-LISTVIEW-EXPORT">
			...
			<div id="opt-content">
				<form id="contentForm" method="post" action="">
					<grid:jqGrid gridId="list" url="${chartdesignctx}/list-definition/list-datas.htm" code="CHARTDESIGN_LIST_VIEW"></grid:jqGrid>
				</form>
