...
<head>
	...
	<c:set var="actionBaseCtx" value="${ecmctx}/ecn" />
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			<div class="opt-btn">
				...
				<s:else>
					<button class='btn' onclick="javascript:window.location='${ecmctx}/ecn/input.htm';" type="button"><span><span><b class="btn-icons btn-icons-add"></b>新建</span></span></button>
					<security:authorize ifAnyGranted="ecm-ecn-save,ecm-ecn-submit-process">
						<button class='btn' type="button" onclick="submitForm('${ecmctx}/ecn/save.htm');"><span><span><b class="btn-icons btn-icons-save"></b>保存</span></span></button>
						<button class='btn' type="button" onclick="submitForm('${ecmctx}/ecn/submit-process.htm');"><span><span><b class="btn-icons btn-icons-submit"></b>提交</span></span></button>
					</security:authorize>
				</s:else>
				<s:if test="taskId>0">
				...
				<c:if test="${id>0}">
					<security:authorize ifAnyGranted="ecm_ecn-export-form">
