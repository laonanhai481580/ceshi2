...
<head>
	...
	function click(cellvalue, options, rowObject){	
		return "<a href='#' onclick='javascript:callList(\""+rowObject.id+"\")'>"+cellvalue+"</a>";
	}
	var myId = '';
	function callList(id){
		myId = id;
		var url='${ecmctx}';
		$.colorbox({href:url+"/dern/view-info.htm?id="+id,iframe:true, 
			...
			<aa:zone name="main">
				...
				<div id="opt-content">
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="dynamicInspection"  url="${ecmctx}/dern/list-datas.htm" code="ECM_DCRN_REPORT_HIS" pageName="page"></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
