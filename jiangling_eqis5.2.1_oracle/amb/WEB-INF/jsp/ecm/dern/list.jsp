...
<head>
	...
	function click(cellvalue, options, rowObject){	
		return "<a href='${ecmctx}/dern/input.htm?id="+rowObject.id+"'>"+cellvalue+"</a>";
	}
	
	function create(){
		window.location.href='${ecmctx}/dern/input.htm';
	}
	...
	function _viewProcessInfo(formId){
		$.colorbox({href:'${ecmctx}/dern/view-info.htm?id='+formId,iframe:true,
		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn" id="btnDiv">
					...
					<security:authorize ifAnyGranted="ecm-dern-delete">
					...
					<security:authorize ifAnyGranted="ecm-dern-export">
						<button class='btn' type="button"  onclick="iMatrix.export_Data('${ecmctx}/dern/export.htm');"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
				</div>
				<div id="opt-content">
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="dynamicInspection"  url="${ecmctx}/dern/list-datas.htm" code="ECM_DCRN_REPORT" pageName="page"></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
