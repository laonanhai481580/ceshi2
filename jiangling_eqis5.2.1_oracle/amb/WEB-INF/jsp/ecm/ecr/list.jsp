...
<head>
	...
	function click(cellvalue, options, rowObject){	
		return "<a href='${ecmctx}/ecr/input.htm?id="+rowObject.id+"'>"+cellvalue+"</a>";
	}
	
	function create(){
		window.location.href='${ecmctx}/ecr/input.htm';
	}
	...
	function _viewProcessInfo(formId){
		$.colorbox({href:'${ecmctx}/ecr/view-info.htm?id='+formId,iframe:true,
		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn" id="btnDiv">
					...
					<security:authorize ifAnyGranted="ecm-ecr-delete">
					...
					<security:authorize ifAnyGranted="ecm-ecr-export">
						<button class='btn' type="button"  onclick="iMatrix.export_Data('${ecmctx}/ecr/export.htm');"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
				</div>
				<div id="opt-content">
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="dynamicInspection"  url="${actionBaseCtx}/list-datas.htm" code="ECM_ECR_REPORT" pageName="page"></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
