...
<form action="${supplierctx}/admittance/sublots-appraisal-report/complete-task.htm" method="post" id="appraisalReportForm" name="appraisalReportForm" >
...
<!-- 				<button class="btn" type="button" onclick="uploadFiles();"><span><span><b class="btn-icons btn-icons-upload"></b>上传</span></span></button> -->
		...
		<tr>
			...
			<td colspan="5"><input type="radio" name="isImprovement" <s:if test="isImprovement"> checked="checked" </s:if>value="true"/>是&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="isImprovement" <s:if test="!isSameBatchCondition"> checked="checked" </s:if> value="false"/>否</td>
		</tr>
			<tr>
		...
		<tr>
			...
			<td >整改期限要求：</td>
			<td ><input name="rectificationDate"  style="width: 70%" value="${rectificationDate}" id="rectificationDate"/>
