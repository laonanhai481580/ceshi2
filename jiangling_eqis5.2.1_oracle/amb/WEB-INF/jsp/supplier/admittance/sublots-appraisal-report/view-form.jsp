...
<div id="opt-content" class="opt-content">
		...
		<table class="form-table-border-left" id="appraisal-table"	style="width:100%">
				...
				<caption style="margin-bottom:4px;">
					<div style="float:left">
						小批鉴定阶段:第<span id="timeOfPhaseSpan">${appraisalReport.timeOfPhase}</span>次小批鉴定
					</div>
					<div style="float:right;padding-right:8px;padding-bottom:4px;">编号:${appraisalReport.code}</div>
				</caption>
				<tr>
