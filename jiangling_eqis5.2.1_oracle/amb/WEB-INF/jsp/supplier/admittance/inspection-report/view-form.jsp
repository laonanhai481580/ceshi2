			...
			<tr height=29>
				...
				<td>
					<%
						...
						double val = 0.0;
						if(childGridType.getRealFee() != null&&childGridType.getTotalFee() != null){
							if(childGridType.getTotalFee()>0){
								val = childGridType.getRealFee()/childGridType.getTotalFee();							
							}
						}
						real.put("value",val*100.0);
						realData.add(real);
					%>
					<%=df.format(val)%>
				</td>
