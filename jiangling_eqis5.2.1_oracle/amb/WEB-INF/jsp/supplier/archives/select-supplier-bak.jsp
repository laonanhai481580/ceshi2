...
///////////////页面使用方法结束////////////////////////////////////
		...
		function createGrid(){
			var colModel = [
				...
				{label:'供应物料',name:'supplyMaterial',index:'supplyMaterial', width:180,hidden:false},
				{label:'材料类别',name:'materialType',index:'materialType',width:120,hidden:false},
...
<input type="hidden" id="state" name="state" value="合格"/>
	<div class="opt-body">
			...
			<table class="form-table-outside-border" style="width:100%;display:block;margin:0px auto;" id="searchTable">
				...
				<tr>
					<td style="text-align:right;">
						<button class="btn" onclick="search();"><span><span><b class="btn-icons btn-icons-search"></b>查询</span></span></button>
