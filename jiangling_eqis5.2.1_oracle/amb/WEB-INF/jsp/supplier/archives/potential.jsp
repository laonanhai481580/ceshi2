...
<script type="text/javascript">
	...
	function $processRowData(data){
		data.state = '<%=Supplier.STATE_POTENTIAL%>';
		return data;
	}
	//修改供应商信息
	...
	function exportSuppliers(){
		var state = '<%=Supplier.STATE_POTENTIAL%>';
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<grid:jqGrid gridId="suppliers"
						url="${supplierctx}/archives/potential-list-datas.htm" code="SUPPLIER_SUPPLIER_POTENTIAL"></grid:jqGrid>
				</form>
			</div>
		</div>
	</div>
