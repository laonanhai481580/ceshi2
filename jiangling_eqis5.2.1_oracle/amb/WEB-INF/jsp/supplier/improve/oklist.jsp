...
<head>
	...
	function selectTypeChange(obj){
		...
		window.location.href = encodeURI('${actionBaseCtx}/oklist.htm?selectType='+ selectType);
	}
	</script>
</head>
		...
		<div class="opt-body">
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="supplier-improve-okexport">
					    <button  class='btn' onclick="iMatrix.export_Data('${actionBaseCtx}/okexport.htm');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>		
					</security:authorize> 
				...
				<div id="opt-content">
					<form id="contentForm" method="post" action="" >
						<grid:jqGrid gridId="dynamicComplain" url="${actionBaseCtx}/list-okdatas.htm?selectType=${selectType}" code="SUPPLIER_OKIMPROVE" pageName="page" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
