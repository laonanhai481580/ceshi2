	    ...
	    <tr>
	     ...
	     <tr>
	         ...
	         <td>
              ...
              <a class="small-button-bg" style="margin-left:2px;" onclick="clearValue('reportChecker','reportCheckerLog')" href="javascript:void(0);" title="<s:text name='清空'/>"><span class="ui-icon ui-icon-trash" style='cursor:pointer;'></span></a>
	          </td>
	         <td>SQE确认</td>
	         <td colspan='5'>
	            <input id="sqeChecker" name="sqeChecker" style="float:left;" hiddenInputId="sqeCheckerLog" isUser="true" value="${sqeChecker}"/>
	             <input type="hidden" name="sqeCheckerLog" id="sqeCheckerLog"  value="${sqeCheckerLog}" />
              	<a class="small-button-bg" style="margin-left:2px;" onclick="clearValue('sqeChecker','sqeCheckerLog')" href="javascript:void(0);" title="<s:text name='清空'/>"><span class="ui-icon ui-icon-trash" style='cursor:pointer;'></span> </a>  
	         </td>
	     </tr>
	     ...
	     <tr>
	      ...
	      <tr>
	         ...
	         <td>
              ...
              <a class="small-button-bg" style="margin-left:2px;" onclick="clearValue('pmcChecker','pmcCheckerLog')" href="javascript:void(0);" title="<s:text name='清空'/>"><span class="ui-icon ui-icon-trash" style='cursor:pointer;'></span></a>
	          </td>
	     </tr>	     
...
<%-- 	      <tr >
	         ...
	         <td>审核</td>
	         <td>
 				<input id="sqeAuditer" name="sqeAuditer" value="${sqeAuditer}" isUser="true" style="float:left;" hiddenInputId="sqeAuditerLog"/>
	            <input type="hidden" name="sqeAuditerLog" id="sqeAuditerLog"  value="${sqeAuditerLog}" />
             	<a class="small-button-bg" style="margin-left:2px;" onclick="clearValue('sqeAuditer','sqeAuditerLog')" href="javascript:void(0);" title="<s:text name='清空'/>"><span class="ui-icon ui-icon-trash" style='cursor:pointer;'></span></a>
             </td>
             <td></td><td></td>
	     </tr> --%>
	     </security:authorize>
	     ...
	     <tr>
	      ...
	      <tr >
			  ...
			  <td>
                 ...
                 <a class="small-button-bg" style="margin-left:2px;" onclick="clearValue('sqeApprovaler','sqeApprovalerLog')" href="javascript:void(0);" title="<s:text name='清空'/>"><span class="ui-icon ui-icon-trash" style='cursor:pointer;'></span>
	          </td>   
	          <td></td>
	          <td>
