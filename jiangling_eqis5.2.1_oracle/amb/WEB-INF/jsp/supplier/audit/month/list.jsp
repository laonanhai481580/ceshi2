...
// 		$("#contentForm").submit();
	...
	function editData(){
		...
		var url = '${supplierctx}/audit/month/input.htm';
		var title = "编辑";
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			<div class="opt-btn">
			 <security:authorize ifAnyGranted="supplier-audit-month-edit">
			...
			<div id="opt-content" style="clear:both;">
				<form id="contentForm" name="contentForm" method="post" action="">
					<grid:jqGrid gridId="suppliers"
						url="${supplierctx}/audit/month/list-datas.htm" code="SUPPLIER_MONTH_CHECK"></grid:jqGrid>
				</form>
			</div>
		</div>
	</div>
