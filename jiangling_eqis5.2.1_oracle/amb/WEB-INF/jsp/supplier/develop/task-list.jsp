...
<head>
	...
	<script type="text/javascript">
		function formNoFormate(value,o,obj){
			return "<a title=\"<s:text name='develop.message-9'/>\"  href='javascript:_viewProcessInfo("+obj.formId+");'>"+value+"</a>";
		}
		function _viewProcessInfo(formId){
			$.colorbox({href:'${actionBaseCtx}/view-info.htm?id='+formId,iframe:true,
				...
				overlayClose:false,
				title:"<s:text name='develop.message-10'/>"
			});
		}
