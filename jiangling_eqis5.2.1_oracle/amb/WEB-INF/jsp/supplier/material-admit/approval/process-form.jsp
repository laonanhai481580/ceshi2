...
function setOptionsValue(obj){
	document.getElementsByName("opinion")[0].value=obj.value;
}
</script>
<div class="opt-content" style="overflow-y:auto;padding: 0px">
	...
	<s:if test="task.active!=2">
		<table class="form-table-border-left" id="opinion-table" style="width:100%;margin: auto;">
			<tr height=28>
			...
			<tr height=28>
				<td>
					<textarea rows="6" style="width:99.6%;" name="opinion"></textarea>
				</td>
			</tr>
		</table>
	</s:if>
	...
	<table class="form-table-border-left" id="history-table" style="width:100%;margin: auto;">
		<tr height=28>
			<td style="background:#99CCFF;font-weight: bold;font-size:14px;width:50px;text-align: center">
				序号
			</td>
			<td style="background:#99CCFF;font-weight: bold;font-size:14px;width:140px;text-align: center">
				时间
			</td>
			<td style="background:#99CCFF;font-weight: bold;font-size:14px;width:100px;text-align: center">
				办理人
			</td>
			<td style="background:#99CCFF;font-weight: bold;font-size:14px;width:90px;text-align: center">
				任务
			</td>
		...
		%>
			<tr height=24>
				...
				<td>
					<%=DateUtil.formateTimeStr(param.getCreatedTime()) %>
				</td>
				<td>
