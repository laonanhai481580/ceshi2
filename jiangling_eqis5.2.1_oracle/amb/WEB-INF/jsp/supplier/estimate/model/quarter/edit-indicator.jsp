...
<script type="text/javascript">
		...
		function isEstimateChange(obj,id){
			...
			if(rowData){
				...
				$.post("${supplierctx}/estimate/model/quarter/save-indicator.htm",params,function(result){
					if(result.error){
		...
		$(document).ready(function(){
			jQuery("#estimateModelList").jqGrid({
				url:'${supplierctx}/estimate/model/quarter/edit-indicator-datas.htm',
				postData : postData,
				treedatatype: "json",
...
// 				ExpandColClick : true,
				...
				cellEdit: true, 
				cellsubmit : 'remote',
				cellurl : "${supplierctx}/estimate/model/quarter/save-indicator.htm?estimateModelId=${estimateModelId}",
