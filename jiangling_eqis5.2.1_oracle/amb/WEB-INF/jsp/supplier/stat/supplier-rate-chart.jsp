...
<head>
		...
		chart = new Highcharts.Chart({
			...
			xAxis: {
				...
				labels : {
					...
					//formatter: function() {
					//	var str ="";
					//	var asString = this.value;
					//	while(asString.length>4){
					//		str+=asString.substr(0,4)+" ";
					//		asString = asString.substr(4,asString.length);
					//	}
					//	str+=" "+asString;
		            //   return str;
		            //}
	...
	function showDetailByDate(inspectionPoint,dutySupplier){
		...
		params['params.dutySupplier'] = dutySupplier;
		params['params.state'] = 'supplier';
		...
		<div class="opt-body" >
			...
			<div id="search">
				<table class="form-table-outside-border" style="width:100%;">
					<tr>
						<td style="width:70px;text-align: right;">检验日期</td>
						<td><input id="datepicker1" type="text" name="params.startDate_ge_date" readonly="readonly" style="width:72px;" class="line" value="<%=startDateStr%>"/>至
						    <input id="datepicker2" type="text" name="params.endDate_le_date" readonly="readonly" style="width:72px;" class="line" value="<%=endDateStr%>"/></td>
						<td style="text-align:right;width:80px;">供应商</td>
						<td>
							<input type="text" onclick="dutySupplierClick();" id="params.dutySupplier" name="params.dutySupplier" style="width:178px;"/>
						</td>
						<td style="text-align: right;">
							<security:authorize ifAnyGranted="stat-supplier-rate">
