...
<head>
	...
	<c:set var="actionBaseCtx" value="${gpctx}/gpmaterial/sub"/>
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			setTimeout(function(){
				$("#opt-content").height($(window).height()-25);
			},500);
		});
		
		function click(id) {
			return href='${gpctx}/gpmaterial/input.htm?id='+id;
		}
// 		function closeBtn(){
...
<!-- 			</div> -->
			<div id="opt-content" style="overflow-y:auto;">
				<div id="tabs" >
					<ul>
						<li><a href="#tabs-1">详情信息</a></li>
					</ul>
					<form  method="post" id="listForm" name="listForm" action="" >
						<jsp:include page="select-input-form.jsp" />
					</form>
				</div>
			</div>
		</div>
