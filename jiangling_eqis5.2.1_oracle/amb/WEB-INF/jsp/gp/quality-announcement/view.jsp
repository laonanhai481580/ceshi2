				...
				<input type="hidden" name="projectPlanId" id="projectPlanId"></input>
						<span style="margin-left:6px;line-height:30px;color: red;" id="message"></span>
								<table style="width: 800px;">
									...
									<tr align="center">
										<td align="center"><span style="text-align: center;line-height:80px;">【发布时间】:<span id="time"><s:date name='releaseTime' format='yyyy-MM-dd'/></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;【来源】:${publishOrganization}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;【作者】:${publisher}</span></td>
							  		</tr>
									<tr>
									<td  colspan="8">${content}</textarea></td>
									</tr>
									<tr align="right">
										<td align="right">${publishOrganization}</br><s:date name='releaseTime' format='yyyy-MM-dd'/></span></td>
							  		</tr>
							  		<tr align="left">
