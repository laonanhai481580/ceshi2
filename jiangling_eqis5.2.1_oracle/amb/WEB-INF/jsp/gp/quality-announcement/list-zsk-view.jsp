...
<script type="text/javascript">
	function searchClick(){
		var search = $("#search").val();
 		$("#listView").attr("src","list-view-datas.htm?announcementType=知识库&pageNo="+this.pageNo+"&search="+search);
	}
	//查看公告
	...
	function setPageNo(obj){
		...
		$("#listView").attr("src","list-datas.htm?announcementType=知识库&pageNo="+this.pageNo+"&search="+search);
	}
	//----分页----//
</script>
</head>
...
<body>
	<script type="text/javascript">
		...
		var thirdMenu="quality-announcement-list-zsk-view";
	</script>
		...
		<div class="opt-body">
			<div id="opt-content" style="clear:both;" align="center">
					...
					<div style="width:100%;height: 80%">
						<iframe id="listView" src="list-view-datas.htm?pageNo=1&announcementType=知识库"></iframe>
					</div>
