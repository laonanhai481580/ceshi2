...
// 				}else 
			...
			$.post('${epmctx}/rel/isHarmful.htm?id='+id+'&&type='+str,
		 	function(data){
		 		window.location.reload(href='${epmctx}/rel/list-datas.htm?type=1');
				alert(data);
		 	});
		}
		
		function selectQualityType(obj){
			window.location.href = encodeURI('${epmctx}/rel/list-pending.htm?factorySupply='+ obj.value);
		}
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_REL_LIST_PENDING";
	</script>
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<aa:zone name="main">
				<div class="opt-btn">
					<security:authorize ifAnyGranted="rel_isHarmful">
 					...
 					<%} %>
					<security:authorize ifAnyGranted="EPM_REL_PENDING_DELETE">
...
<%-- 					<security:authorize ifAnyGranted="EPM_REL_PENDING_EXPORT">
				...
				<div id="opt-content" >
					<form id="contentForm" name="contentForm" method="post"  action="">                                                    
						<grid:jqGrid gridId="list" url="${epmctx}/rel/list-datas.htm?type=1" submitForm="defaultForm" code="EPM_REL" ></grid:jqGrid>
				</div>
			</aa:zone>
		</div>
	</div>
