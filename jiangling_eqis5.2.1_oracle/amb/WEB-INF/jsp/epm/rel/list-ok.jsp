...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<aa:zone name="main">
				<div class="opt-btn">
				<security:authorize ifAnyGranted="EPM_REL_OK_DELETE">
				...
				<security:authorize ifAnyGranted="EPM_REL_OK_EXPORT">
				...
				<div id="opt-content" >
					<form id="contentForm" name="contentForm" method="post"  action="">                                                    
						<grid:jqGrid gridId="list" url="${epmctx}/rel/list-datas.htm?type=2" submitForm="defaultForm" code="EPM_REL"></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
