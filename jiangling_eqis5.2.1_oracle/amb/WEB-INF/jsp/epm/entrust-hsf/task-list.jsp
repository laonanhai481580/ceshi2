...
<head>
	...
	<script type="text/javascript">
		function formNoFormate(value,o,obj){
			return "<a title=\"<s:text name='gsm.message-9'/>\"  href='javascript:_viewProcessInfo("+obj.formId+");'>"+value+"</a>";
		}
		function _viewProcessInfo(formId){
			$.colorbox({href:'${actionBaseCtx}/view-info.htm?id='+formId,iframe:true,
				...
				overlayClose:false,
				title:"<s:text name='gsm.message-10'/>"
			});
		}
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			<form id="defaultForm" name="defaultForm" method="post"  action="">
			</form>
			<div class="opt-btn">
...
<%-- 				</security:authorize> --%>
			...
			<div id="opt-content" >
				<form id="contentForm" name="contentForm" method="post"  action="">
					<grid:jqGrid gridId="list" url="${actionBaseCtx}/task-list-datas.htm" submitForm="defaultForm" code="	" pageName="taskPage"></grid:jqGrid>
				</form>
			</div>
		</div>
	</div>
