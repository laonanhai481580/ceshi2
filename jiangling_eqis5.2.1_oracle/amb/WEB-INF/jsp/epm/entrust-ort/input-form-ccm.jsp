			...
			<div style="overflow-x:auto;overflow-y:hidden;">
				...
				<tbody>
					<tr >	
						...
						<td  style="width:100px;text-align:center;border-top:0px;">试验项目</td>
						<td  style="width:100px;text-align:center;border-top:0px;">测试条件</td>
					...
					<s:iterator value="_entrustOrtSublists" id="item" var="item">
						<tr class="entrustOrtSublists">
							...
							<td style="text-align: center;"><input  style="width:90%;" name="ortId" type="hidden" value="${ortId }" /><textarea stage="one" style="width:95%;" name="testCondition" value="${testCondition }"></textarea></td>
							<td style="text-align: center;"><input stage="one" style="width:90%;" name="testNumber" value="${testNumber }" /></td>
							<td style="text-align: center;"><textarea stage="one" style="width:95%;" name="criterionG" value="${criterionG }" ></textarea></td>
							<td style="text-align: center;"><textarea stage="one" style="width:95%;" name="criterionY" value="${criterionY }" ></textarea></td>
							<td style="text-align: center;"><textarea stage="one" style="width:95%;" name="criterionR" value="${criterionR }" ></textarea></td>
							...
							<td style="text-align: center;"><input style="width:100%;" type="hidden" isFile="true" name="testReport" value="${testReport }" />
								<input style="width:100%;"  type="hidden" name="id" value="${item.id}" />
								<input style="width:100%;"  type="hidden" name="ortId" value="${ortId}" />
							</td>
						     <td style="text-align: center;" >
