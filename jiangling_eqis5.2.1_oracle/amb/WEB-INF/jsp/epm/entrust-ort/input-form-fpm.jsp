				...
				<tbody>
					...
					<s:iterator value="_entrustOrtSublists" id="item" var="item">
						<tr class="entrustOrtSublists" zbtr1=true>
							...
							<textarea stage="one" style="width:95%;" name="testCondition" rows="7" >${testCondition }</textarea></td>
							...
							<td style="text-align: center;"><textarea stage="one" style="width:95%;" name="criterionG" value="" rows="4" >${criterionG }</textarea></td>
