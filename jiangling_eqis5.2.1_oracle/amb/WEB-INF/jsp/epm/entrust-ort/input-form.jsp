				...
				<tbody>
					...
					<s:iterator value="_entrustOrtSublists" id="item" var="item">
						<tr class="entrustOrtSublists" zbtr1=true>
						    ...
						    <td style="text-align: center;"><textarea stage="one" style="width:80%;" name="testStation"  >${testStation }</textarea></td>
							...
							<td style="text-align: center;"><textarea stage="one" style="width:80%;" name="lower" >${lower }</textarea></td>
							<td style="text-align: center;"><textarea stage="one" style="width:80%;" name="upper" >${upper }</textarea></td>
							...
							<td style="text-align: center;"><textarea stage="one" style="width:80%;" name="upload"  >${upload}</textarea></td>
