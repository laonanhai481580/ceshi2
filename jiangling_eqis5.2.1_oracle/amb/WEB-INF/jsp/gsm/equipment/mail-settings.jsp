...
<script type="text/javascript">
	...
	function submitForm(url){ 
		if($("#contentForm").valid()){
			...
			var paras = new Array();
			if(rows.length<1){
				alert("<s:text name='gsm.message-36'/>");
				return;
			}
			...
			var delayRemindSwitch = $(":input[name=delayRemindSwitch]").attr("checked");
			params.delayRemindSwitch=delayRemindSwitch;
			if(delayRemindSwitch){
				params.days1 = $(":input[name=days1]").val();
			} 
