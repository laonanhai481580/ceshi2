...
<script type="text/javascript">
	...
	function createPersonGrid(){
		$("#person_table").jqGrid({
			url : '${gsmctx}/equipment/warn-user-datas.htm',
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<div class="ui-layout-center">
		<div class="opt-body" style="overflow-y:auto;">
			<aa:zone name = "main">
				<div class="opt-btn">
				<button class='btn' onclick="submitForm('${gsmctx}/equipment/save-mail-settings.htm');"><span><span><b class="btn-icons btn-icons-save"></b>保存</span></span></button>
				...
				<div style="margin-top:15px; margin-left: 10px;margin-right:10px">
					...
					<input type="hidden" id="businessCode" name="businessCode"></input>
					<fieldSet>
						...
						<table style="width:100%;margin-top:8px;" cellpadding="0" cellspacing="0" id="advanceRemindTable">
				    		<tr>
				    			<td>&nbsp;&nbsp;&nbsp;<s:text name="超期"/><input type="text"  style="width:60px;" id="days" name="days" value="${days}"  class="{required:true,number:true,min:0,messages:{number:请填写有效数字,min:最小为0}}"/>&nbsp;<s:text name="天提醒"/></td>
				    		</tr>
				    		<tr>
				    			<td>
					...
					<fieldSet style="margin-top:6px;">
						<legend>&nbsp;&nbsp;<label for="setPerson"><s:text name="gsm.mail.userName"/>&nbsp;&nbsp;</label></legend>
