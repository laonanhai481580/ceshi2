					...
					<form id="contentForm" name="contentForm" method="post" >
						...
						<fieldSet>
							...
							<table style="width:100%;margin-top:8px;" cellpadding="0" cellspacing="0" id="advanceRemindTable">
					    		<tr>
					    			<td>&nbsp;&nbsp;&nbsp;<s:text name="提前"/><input type="text"  style="width:60px;" id="days" name="days" value="${days}" class="{required:true,number:true,min:0,messages:{number:请填有效数字,min:最小为0}}"/>&nbsp;<s:text name="天提醒。"/></td>
					    		</tr>
					    		<tr>
					    			<td>
