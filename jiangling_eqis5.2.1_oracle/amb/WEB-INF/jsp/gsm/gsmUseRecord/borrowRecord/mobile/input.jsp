...
<script type="text/javascript" src  ="${resourcesCtx}/widgets/validation/dynamic.validate.js" ></script>
 ...
 <body>
 <div class="cause">
	<a><span class="cause_0"><img src="${ctx}/mobile/img/comeback.png"></span></a><span class="cause_1">仪器借调申请单</span>
 </div>
...
<input name="taskId" id="taskId" value="${taskId}" type="hidden"/>
 <div class="csh">
	...
	<li>
		...
		<li>
			...
			<div><input type="date" isDate=true class="partOne" name="borrowDate" id="borrowDate" value="<s:date name="borrowDate" format="yyyy-MM-dd"/>"></div>
		</li>
		<li>
			<div class="syq_2">
				<span>计划归还日期</span>
			</div>
			<div><input type="date" isDate=true class="partOne" name="returnDate" id="returnDate" value="<s:date name="returnDate" format="yyyy-MM-dd"/>"></div>
		</li>
	</ul>
 </div>
 <div class="testoperation">
		...
		<%int bcount=0; %>
		   <s:iterator value="_borrowRecordSublists" var="items" id="items" status="ss">
			<ul class="ulcontent">
				<li id="addcontent_a"><span>仪器管理编号</span><input type="text" name="managerAssets" id="managerAssets_<%=bcount%>" value='${managerAssets }' class="textwidth"></li>
				<li id="addcontent_b"><span>仪器名称</span><input type="text" name="equipmentName" id="equipmentName_<%=bcount%>" value='${equipmentName }' class="textwidth"></li>
				<li id="addcontent_c"><span>规格型号</span><input type="text" name="equipmentModel" id="equipmentModel_<%=bcount%>" value='${equipmentModel }'  class="textwidth"></li>
				<li id="addcontent_d"><span>品牌</span><input type="text" name="brand" id="brand_<%=bcount%>" value="${brand }" class="textwidth"></li>
				<li id="addcontent_e"><span>备注</span><input type="text" name="remark" id="remark_<%=bcount%>" value="${remark }" class="textwidth"></li>
			</ul>
			<% bcount++; %>
			</s:iterator>
...
// 				node2.class="ulcontent";
				...
				node2.innerHTML='<li id="addcontent_a"><span>仪器管理编号</span><input type="text" name="managerAssets" id="managerAssets_"' + total +' value="${managerAssets }" class="textwidth"></li><li id="addcontent_b"><span>仪器名称</span><input type="text" name="equipmentName" id="equipmentName_"'+total+' value="${equipmentName }" class="textwidth"></li><li id="addcontent_c">'+
				'<span>规格型号</span><input type="text" name="equipmentModel" id="equipmentModel_"'+total+' value="${equipmentModel }"  class="textwidth"></li><li id="addcontent_d"><span>品牌</span><input type="text" name="brand" id="brand_"'+total+' value="${brand }" class="textwidth"></li><li id="addcontent_e">'+
	...
	<ul class="syq_1">
		<li>
			...
			<div><input type="date"  class="partOne" name="borrower" id="borrower" value="${borrower }"></div>
		</li>
		<li>
			<div class="syq_2">
				<span>借用部门</span>
			</div>
			<div><input type="date" isDate=true class="partOne" name="borrowerDept" id="borrowerDept" value="${borrowerDept }"></div>
		</li>
	</ul>
 </div>
  <div class="admit_infor">
   ...
   <textarea id="depository"></textarea>
  <div class="polling">
	<ul class="polling_sell">
		<li>
			<div class="polling_sell_1"><span>原保管人</span></div>
			<div class="polling_sell_2">
				<input type="text" name="preserver" id="preserver" value="${preserver}">
				<input type="hidden" name="preserverLogin" id="preserverLogin" value="${preserverLogin }">
				<a id="polling_fdj" class="polling_fdj" onclick="searchPerson('preserver','preserverLogin')" >
					<img src="${ctx}/mobile/img/fdj.png">
				</a>
					<%-- <sub>	
						<b>*</b>
					</sub>
				<a id="polling_ljt" onclick="del('preserver','preserverLogin')">
		...
		<li>
			...
			<div>
			  <input type="text"  class="partOne" name="preserverDept" id="preserverDept" value="${preserverDept }">
			</div>
		</li>
		<li>
			<div class="syq_2">
			...
			<div>
			  <input type="date" isDate=true class="partOne" name="preserverDate" id="preserverDate" value="<s:date name="preserverDate" format="yyyy-MM-dd"/>">
			</div>
		</li>
	</ul>
 </div>
 <div class="admit_infor">
  ...
  <div class="polling">
	<ul class="polling_sell">
		<li>
			<div class="polling_sell_1"><span>实验室确认人</span></div>
			<div class="polling_sell_2">
				...
				<a id="polling_ljt" onclick="del('confirmor','confirmorLogin')">
					<img src="${ctx}/mobile/img/ljt.png">
				</a> --%>
			</div>	
		</li>
		<li>
			...
			<div>
			  <input type="text"  class="partOne" name="confirmorDept" id="confirmorDept" value="${confirmorDept }">
			</div>
		</li>
		<li>
			<div class="syq_2">
			...
			<div>
			  <input type="date" isDate=true class="partOne" name="confirmorDate" id="confirmorDate" value="<s:date name="confirmorDate" format="yyyy-MM-dd"/>">
			</div>
		</li>
	</ul>
 </div>
 ...
 <div id="ym"><p><span>查看意见</span><a id="processFormId"><img src="${ctx}/mobile/img/cha.png" /></a></p></div>
  ...
  <script>
	  $('#down_select').click(function(){
			$('#laboratory').slideToggle();
		});
	  $('#select_down').click(function(){
			$('#depository').slideToggle();
		});
