...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<chart:view 
		chartDefinitionCode="gsm-inspection-complete-rate"
		secMenu="analysis"
		secMenuJspPath="/menus/gsm-sec-menu.jsp"
		thirdMenu="complete_rate"
		thirdMenuJspPath="/menus/gsm-analysis-third-menu.jsp"/>
</body>
</html>	
