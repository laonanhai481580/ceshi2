...
function copyPersonCallBack(selectHiddenValue) {
	...
	$("#applicationForm").attr("action", "${gsmctx}/new-equipment/copytask.htm?copyPerson=" + selectHiddenValue);
	$("#applicationForm").ajaxSubmit(function(id) {
		alert(id);
	});
}
function assignUser(selectHiddenValue){
	var url ="${gsmctx}/new-equipment/assign.htm?assignee="+selectHiddenValue;
...
// 		}
		...
		$("#applicationForm").attr("action","${gsmctx}/new-equipment/save.htm");
	...
	function submitForm(){
		...
		$("#applicationForm").attr("action",'${gsmctx}/new-equipment/submit-process.htm');
		$("#applicationForm :input[name]").removeAttr("disabled");
		$("#applicationForm").submit();
	}
	...
	function _completeTask(taskTransact) {
		...
		$("#applicationForm :input[name]").removeAttr("disabled");
		$("#applicationForm").attr("action","${gsmctx}/new-equipment/complete-task.htm");
		var validator = $("#applicationForm").data('validator');
		if(validator){
			validator.cancelSubmit = true;
		}
