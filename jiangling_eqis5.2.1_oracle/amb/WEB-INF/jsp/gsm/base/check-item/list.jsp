...
<script type="text/javascript">
	$.extend($.jgrid.defaults,{
		...
		function $beforeEditRow(rowId,iRow,iCol,e){
			var isRight = false;
			<security:authorize ifAnyGranted="GSM_CHECK_ITEM_SAVE">
			  isRight =  true;
			</security:authorize>
			return isRight;
		}
		...
		<div class="opt-body">
			<aa:zone name = "main">
				...
				<security:authorize ifAnyGranted="GSM_CHECK_ITEM_SAVE">
					...
					<security:authorize ifAnyGranted="GSM_CHECK_ITEM_DELETE">
				...
				<div style="margin-top:15px; margin-left: 10px;">
					<form id="contentForm" name="contentForm" method="post"  action="">
						<grid:jqGrid gridId="itemList"  url="${gsmctx}/base/check-item/list-datas.htm" code="GSM_CHECK_ITEM" pageName="page"></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
