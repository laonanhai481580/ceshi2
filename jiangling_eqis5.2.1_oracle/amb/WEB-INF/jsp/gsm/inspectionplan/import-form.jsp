...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<div class="opt-body">
			<form  id="importForm" name="importForm" method="post" action="${gsmctx}/inspectionplan/imports.htm" enctype ="multipart/form-data" onsubmit="return submitForm()">
				<div class="opt-btn">
				...
				<div id="opt-content">
					<table>
						<tr>
							<td align=right style="width:110px;"><s:text name='选择检验标准'/>:</td>
							<td>
