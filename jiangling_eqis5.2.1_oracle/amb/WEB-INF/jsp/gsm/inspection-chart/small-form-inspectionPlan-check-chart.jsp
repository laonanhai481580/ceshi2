...
<head>
	...
	function reportByParams(params){
		$.post("${gsmctx}/inspection-chart/check-chart-datas.htm",params,function(result){
			if(result.error){
	...
	function showDetailByDate(name,StartDate,EndDate){
		...
		var url = '${gsmctx}/inspection-chart/check-chart-detail.htm?1=1';
				...
				<div id="search" style="display:block;padding:4px;">
					<table class="form-table-outside-border" style="width:100%" >
						<tr>
							...
							<td>
								<input id="datepicker1" type="text" readonly="readonly" style="width:72px;" class="line" name="params.startDate_ge_date" value="<%=startDateStr%>"/>
								<s:text name="gsm.inspection-chart.zhi"/>
