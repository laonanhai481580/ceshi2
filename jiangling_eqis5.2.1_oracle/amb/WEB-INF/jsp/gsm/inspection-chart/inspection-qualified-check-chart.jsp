...
<head>
	...
	function reportByParams(params){
		$.post("${gsmctx}/inspection-chart/qualified-chart-datas.htm",params,function(result){
			if(result.error){
	...
	function showDetailByDate(name,StartDate,EndDate){
		...
		var url = '${gsmctx}/inspection-chart/check-qualified-chart-detail.htm?1=1';
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="inspectionQualifiedReport";
	</script>
