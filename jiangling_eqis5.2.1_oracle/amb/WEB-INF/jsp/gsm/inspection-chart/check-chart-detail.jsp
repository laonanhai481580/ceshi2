	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			jQuery("#inspectionReportList").jqGrid({
				...
				autowidth:true,
				shrinkToFit:false,
				url:'${gsmctx}/inspection-chart/check-chart-detail-datas.htm',
				...
				colModel:[
		                ...
		                editurl: "${gsmctx}/inspection-report/save.htm",
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<div class="ui-layout-center">
		<div class="opt-body">
			<div style="margin:6px auto;text-align:center;font-size:16px;font-weight:bold;" id='titleDiv'></div>
			<div id="opt-content">
