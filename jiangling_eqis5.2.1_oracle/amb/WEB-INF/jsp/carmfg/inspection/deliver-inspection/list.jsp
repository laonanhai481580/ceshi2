	...
	<div class="ui-layout-center">
			<div class="opt-body">
				<aa:zone name="main">
					...
					<button class='btn' onclick="window.location='${mfgctx}/inspection/deliver-inspection/input.htm'" type="button"><span><span><b class="btn-icons btn-icons-add"></b>新建</span></span></button>
					<security:authorize ifAnyGranted="MFG_COLLECT_DELIVER_INSPECTION_DELETE">
					...
					<security:authorize ifAnyGranted="MFG_INSPECTION_DELIVER-INSPECTION_LIST_EXPORT">
					<button  class='btn' onclick="iMatrix.export_Data('${mfgctx}/inspection/export/export-deliver-inspection-list.htm');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
					<span id="message"></span>
					</div>
					<div id="opt-content">
						<form id="contentForm" name="contentForm" method="post" action="">
							<grid:jqGrid gridId="dynamicInspection"  url="${mfgctx}/inspection/deliver-inspection/list-datas.htm" code="MFG_FIRST_INSPECTION_REPORT" pageName="page"></grid:jqGrid>
						</form>
					</div>
				</aa:zone>
			</div>
