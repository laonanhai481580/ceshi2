	...
	<div class="ui-layout-center">
			<div class="opt-body">
				<aa:zone name="main">
					...
					<security:authorize ifAnyGranted="mfg-inspection-first-inspection-delete">
					...
					<security:authorize ifAnyGranted="mfg-inspection-export-export-first-inspection-list">
					<button  class='btn' onclick="iMatrix.export_Data('${mfgctx}/inspection/export/export-first-inspection-list.htm');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
					<span id="message"></span>
					</div>
					<div id="opt-content">
						<form id="contentForm" name="contentForm" method="post" action="">
							<grid:jqGrid gridId="dynamicInspection"  url="${mfgctx}/inspection/first-inspection/list-datas.htm" code="MFG_FIRST_INSPECTION_REPORT" pageName="page"></grid:jqGrid>
						</form>
					</div>
				</aa:zone>
			</div>
