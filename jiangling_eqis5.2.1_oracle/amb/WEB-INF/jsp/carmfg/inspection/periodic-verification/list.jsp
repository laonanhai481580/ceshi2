...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="periodicVerification";
	</script>
	...
	<div class="ui-layout-center">
			<div class="opt-body">
				<aa:zone name="main">
					...
					<security:authorize ifAnyGranted="MFG_INSPECTION_STORAGE-INSPECTION_LIST_INPUT">
					<button class='btn' onclick="window.location='${mfgctx}/inspection/storage-inspection/input.htm'" type="button"><span><span><b class="btn-icons btn-icons-add"></b>新建</span></span></button>
					</security:authorize>
					<security:authorize ifAnyGranted="MFG_INSPECTION_STORAGE-INSPECTION_LIST_DELETE">
					...
					<security:authorize ifAnyGranted="MFG_INSPECTION_STORAGE-INSPECTION_LIST_EXPORT">
					<button  class='btn' onclick="iMatrix.export_Data('${mfgctx}/inspection/export/export-storage-inspection-list.htm');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
					<span id="message"></span>
					</div>
					<div id="opt-content">
						<form id="contentForm" name="contentForm" method="post" action="">
							<grid:jqGrid gridId="dynamicInspection"  url="${mfgctx}/inspection/storage-inspection/list-datas.htm" code="MFG_FIRST_INSPECTION_REPORT" pageName="page"></grid:jqGrid>
						</form>
					</div>
				</aa:zone>
			</div>
