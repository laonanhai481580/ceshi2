	...
	<div class="ui-layout-center">
			<div class="opt-body">
				<aa:zone name="main">
					...
					<security:authorize ifAnyGranted="MFG_INSPECTION_STORAGE-INSPECTION_LIST-ALL_INPUT">
					...
					<security:authorize ifAnyGranted="MFG_INSPECTION_STORAGE-INSPECTION_LIST-ALL_DELETE">
					...
					<security:authorize ifAnyGranted="MFG_INSPECTION_STORAGE-INSPECTION_LIST-ALL_EXPORT">
					<button  class='btn' onclick="iMatrix.export_Data('${mfgctx}/inspection/export/export-storage-inspection-list-all.htm');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
					</div>
					<div id="opt-content">
						<form id="contentForm" name="contentForm" method="post" action="">
							<grid:jqGrid gridId="dynamicInspection"  url="${mfgctx}/inspection/storage-inspection/list-datas.htm" code="MFG_FIRST_INSPECTION_ALL" pageName="page"></grid:jqGrid>
						</form>
					</div>
				</aa:zone>
			</div>
