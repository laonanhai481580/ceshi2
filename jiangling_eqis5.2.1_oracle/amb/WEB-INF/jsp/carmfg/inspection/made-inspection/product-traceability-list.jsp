...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_product_traceability_list";
	</script>
				...
				<aa:zone name="main">
					...
					<div id="opt-content">
						<form id="contentForm" name="contentForm" method="post" action="">
							<grid:jqGrid gridId="dynamicInspection"  url="${mfgctx}/inspection/made-inspection/product-traceability-list-datas.htm" code="MFG_MANUFACTURE_MESSAGE" pageName="mmPage"></grid:jqGrid>
						</form>
					</div>
				</aa:zone>
			</div>
