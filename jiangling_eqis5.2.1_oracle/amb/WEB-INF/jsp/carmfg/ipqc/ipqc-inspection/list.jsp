...
// 				}else
		...
		function importDatas(){
			...
			var url = encodeURI('${mfgctx}/ipqc/ipqc-inspection/import.htm');
...
/* 		function importDatas(){
		...
		function downloadTemplate(){
			window.location = '${mfgctx}/ipqc/ipqc-inspection/download-template.htm';
		}
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_IPQC_INSPECTION_LIST";
	</script>
		...
		<div class="opt-body">
			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="MFG_IPQC_INSPECTION_DELETE">
					...
					<button id="searchBtn" class='btn'onclick="iMatrix.showSearchDIV(this);"><span><span><b class="btn-icons btn-icons-search"></b>查询</span></span></button>
					 <security:authorize ifAnyGranted="MFG_IPQC_INSPECTION_EXPORT">
					...
					<security:authorize ifAnyGranted="MFG_IPQC_INSPECTION_IMPORT">
				...
				<div id="opt-content" >
					...
					<grid:jqGrid gridId="list" url="${mfgctx}/ipqc/ipqc-inspection/list-datas.htm?type=0" submitForm="defaultForm" code="MFG_IPQC_INSPECTION" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
