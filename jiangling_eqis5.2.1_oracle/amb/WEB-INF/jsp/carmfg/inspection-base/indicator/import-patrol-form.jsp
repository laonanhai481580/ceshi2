...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<div class="opt-body">
			<form  id="importForm" name="importForm" method="post" action="${mfgctx}/inspection-base/indicator/import-patrol.htm" enctype ="multipart/form-data" onsubmit="return submitForm()">
				<div class="opt-btn">
