...
//	 				"initially_select" : [ "root"]
		...
		function createLeftBom(){
			var colModel = [
		   		...
		   		{label:'项目名称',name:'itemName',index:'itemName', width:130,formatter:nameFormatter},
			...
			$("#leftInspectingItemList").jqGrid({
				...
				url:'${mfgctx}/inspection-base/item/list-datas.htm',
				prmNames:{
					rows:'page.pageSize',
					page:'page.pageNo',
					sort:'page.orderBy',
		...
		function nameFormatter(value,o,obj){
			if(obj.hasChild==true||obj.hasChild=='true'){
				return "<a class=\"small-button-bg\" href=\"#\" style='float:left;margin-right:2px;'><span class=\"ui-icon ui-icon-folder-collapsed\"></span></a>" + obj.itemName;
