...
<div class="opt-content" id="opt-content" style="overflow-y:auto;">
	...
	<s:if test="task.active==0">
		<table class="form-table-border-left" id="opinion-table" style="width:91.5%;margin: auto;">
			<tr height=28>
			...
			<tr height=28>
				<td>
					<textarea rows="6" name="opinion"></textarea>
				</td>
			</tr>
		</table>
	</s:if>
	...
	%>
		<table class="form-table-border-left" id="history-table" style="width:91.5%;margin: auto;">
			<tr height=28>
