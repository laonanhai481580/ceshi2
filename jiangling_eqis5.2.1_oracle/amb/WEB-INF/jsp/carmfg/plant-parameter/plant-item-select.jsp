	...
	<script type="text/javascript">
		...
		function createRightBom(){
			var colModel = [
				...
				{label:'设备名称',name:'plantName',index:'plantName'}
		   	];
		...
		function createLeftBom(){
			var colModel = [
		   		{label:'id',name:'id',index:'id', width:1,hidden:true,key:true},
		   		{label:'设备名称',name:'plantName',index:'plantName', width:120},
		   		{label:'参数名称',name:'parameterName',index:'parameterName', width:120},
		   		{label:'参数规格',name:'parameterStandard',index:'parameterStandard', width:120},	
			...
			$("#leftInspectingItemList").jqGrid({
				...
				url:'${mfgctx}/plant-item/list-datas.htm?',
				prmNames:{
					rows:'page.pageSize',
					page:'page.pageNo',
					sort:'page.orderBy',
								...
								<td class="left-right">
									<div class="opt-body">
										<div class="opt-btn" style="line-height:30px;padding-left:4px;">
											设备名称:&nbsp;<input style="width:120px;" id="searchInput"></input>
