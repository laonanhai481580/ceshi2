	...
	<div class="ui-layout-center">
		<div class="opt-body">
			<aa:zone name="main">
				...
				<security:authorize ifAnyGranted="MFG_BASE-INFO_INSPECTION-BASE-INDICATOR_DELETE">
...
<!-- 					<button class='btn' onclick="imports();" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导入</span></span></button> -->
				<security:authorize ifAnyGranted="MFG_BASE-INFO_INSPECTION-BASE-INDICATOR_IMPORT-FORM">
				...
				<!-- <button class='btn' onclick="importPatrol();" type="button"><span><span><b class="btn-icons btn-icons-import"></b>导入工艺纪律检查检验标准</span></span></button> -->
				...
				<security:authorize ifAnyGranted="MFG_BASE-INFO_INSPECTION-BASE-INDICATOR_SET-PATROL">
