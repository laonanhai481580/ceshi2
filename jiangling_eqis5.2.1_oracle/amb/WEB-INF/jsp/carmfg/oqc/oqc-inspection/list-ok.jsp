...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_OQC_INSPECTION_LIST_OK";
	</script>
...
<%-- 	<div class="ui-layout-west">
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<aa:zone name="main">
				<div class="opt-btn">
				<%--<security:authorize ifAnyGranted="MFG_OQC_INSPECTION_OK_SAVE">
					<button class="btn" onclick="iMatrix.addRow();"><span><span><b class="btn-icons btn-icons-add"></b>新建</span></span></button>
					</security:authorize> --%>
					<security:authorize ifAnyGranted="MFG_OQC_INSPECTION_OK_DELETE">
					...
					<security:authorize ifAnyGranted="MFG_OQC_INSPECTION_OK_EXPORT">
				...
				<div id="opt-content" >
					<form id="contentForm" name="contentForm" method="post"  action="">                                                    
						<grid:jqGrid gridId="list" url="${mfgctx}/oqc/oqc-inspection/list-datas.htm?type=2" submitForm="defaultForm" code="MFG_OQC_INSPECTION_REPORT" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
