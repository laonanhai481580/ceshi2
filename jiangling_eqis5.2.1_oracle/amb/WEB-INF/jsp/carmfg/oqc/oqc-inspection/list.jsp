...
// 				}else
		...
		function importDatas(){
			...
			var url = encodeURI('${mfgctx}/oqc/oqc-inspection/import.htm');
		...
		function downloadTemplate(){
			window.location = '${mfgctx}/oqc/oqc-inspection/download-template.htm';
		}
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_OQC_INSPECTION_REPORT_LIST";
	</script>
		...
		<div class="opt-body">
			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="MFG_OQC_INSPECTION_DELETE">
					...
					<security:authorize ifAnyGranted="MFG_OQC_INSPECTION_EXPORT">
					...
					<security:authorize ifAnyGranted="MFG_OQC_INSPECTION_IMPORT">
				...
				<div id="opt-content" >
					...
					<grid:jqGrid gridId="list" url="${mfgctx}/oqc/oqc-inspection/list-datas.htm?type=0" submitForm="defaultForm" code="MFG_OQC_INSPECTION_REPORT" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
