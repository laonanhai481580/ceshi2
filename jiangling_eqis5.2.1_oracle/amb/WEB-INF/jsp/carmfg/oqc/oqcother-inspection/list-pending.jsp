...
// 				}else 
			...
			$.post('${mfgctx}/oqc/oqcother-inspection/isHarmful.htm?id='+id+'&&type='+str,
		 	function(data){
		 		window.location.reload(href='${mfgctx}/oqc/oqcother-inspection/list-datas.htm?type=1');
				alert(data);
		 	});
		}
		
		function selectQualityType(obj){
			window.location.href = encodeURI('${mfgctx}/oqc/oqcother-inspection/list-pending.htm?factorySupply='+ obj.value);
		}
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_OQC_OTHER_INSPECTION_LIST_PENDING";
	</script>
...
<%-- 	<div class="ui-layout-west">
	...
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<aa:zone name="main">
				<div class="opt-btn">
					<security:authorize ifAnyGranted="oqcother-inspection_isHarmful">
 					...
 					<%} %>
					<security:authorize ifAnyGranted="MFG_OQC_OTHER_INSPECTION_PENDING_DELETE">
				...
				<%-- 	<security:authorize ifAnyGranted="MFG_OQC_OTHER_INSPECTION_PENDING_EXPORT">
				...
				<div id="opt-content" >
					<form id="contentForm" name="contentForm" method="post"  action="">                                                   
						<grid:jqGrid gridId="list" url="${mfgctx}/oqc/oqcother-inspection/list-datas.htm?type=1" submitForm="defaultForm" code="MFG_OQC_OTHER_INSPECTION"></grid:jqGrid>  </form>
				</div>
			</aa:zone>
		</div>
	</div>
