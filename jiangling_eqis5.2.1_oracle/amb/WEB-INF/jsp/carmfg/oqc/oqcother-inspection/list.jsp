...
// 				}else
				if(id.length==0){
					alert("请选择一项！");//oqcother-inspection
					return ;
				}
		...
		function importDatas(){
			...
			var url = encodeURI('${mfgctx}/oqc/oqcother-inspection/import.htm');
		...
		function downloadTemplate(){
			window.location = '${mfgctx}/oqc/oqcother-inspection/download-template.htm';
		}
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_OQC_OTHER_INSPECTION_REPORT_LIST";
	</script>
		...
		<div class="opt-body">
			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="MFG_OQC_OTHER_INSPECTION_DELETE">
				...
				<%-- 	<security:authorize ifAnyGranted="MFG_OQC_OTHER_INSPECTION_EXPORT">
					...
					<security:authorize ifAnyGranted="MFG_OQC_OTHER_INSPECTION_IMPORT">
				...
				<div id="opt-content" >
					...
					<grid:jqGrid gridId="list" url="${mfgctx}/oqc/oqcother-inspection/list-datas.htm?type=0" submitForm="defaultForm" code="MFG_OQC_OTHER_INSPECTION" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
