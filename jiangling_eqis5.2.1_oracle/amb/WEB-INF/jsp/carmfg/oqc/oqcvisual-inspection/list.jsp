...
// 				}else
				if(id.length==0){
					alert("请选择一项！");//oqcvisual-inspection
					return ;
				}
		...
		function importDatas(){
			...
			var url = encodeURI('${mfgctx}/oqc/oqcvisual-inspection/import.htm');
...
/* 		function importDatas(){
		...
		function downloadTemplate(){
			window.location = '${mfgctx}/oqc/oqcvisual-inspection/download-template.htm';
		}
...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();" >
	<script type="text/javascript">
		...
		var thirdMenu="_OQC_VISUAL_INSPECTION_REPORT_LIST";
	</script>
		...
		<div class="opt-body">
			...
			<aa:zone name="main">
				<div class="opt-btn">
					...
					<security:authorize ifAnyGranted="MFG_OQC_VISUAL_INSPECTION_DELETE">
				...
				<%-- 	<security:authorize ifAnyGranted="MFG_OQC_VISUAL_INSPECTION_EXPORT">
					...
					<security:authorize ifAnyGranted="MFG_OQC_VISUAL_INSPECTION_IMPORT">
				...
				<div id="opt-content" >
					...
					<grid:jqGrid gridId="list" url="${mfgctx}/oqc/oqcvisual-inspection/list-datas.htm?type=0" submitForm="defaultForm" code="MFG_OQC_VISUAL_INSPECTION" ></grid:jqGrid>
					</form>
				</div>
			</aa:zone>
		</div>
