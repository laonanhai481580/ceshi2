...
//	 			            groupPadding:0.0,
				            ...
				            events : {
				            	click : function(obj){
				            		showDetailByDate(obj.point.date);
				            	}
				            }
				        },
				        line: {
...
// 			var val = $('input:checkbox[name="params.myType"]:checked').val();
		...
		function reportByParams(params){
			$.post("${mfgctx}/manu-analyse/quality-trend-datas.htm",params,function(result){
				if(result.error){
		...
		function showDetailByDate(inspectionDate){
			...
			var url = '${mfgctx}/manu-analyse/quality-trend-detail.htm?1=1';
