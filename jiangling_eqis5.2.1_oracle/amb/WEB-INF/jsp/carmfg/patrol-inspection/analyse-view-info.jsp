...
<input type="hidden" id="id" value="${id}"/>
	...
	<div class="ui-layout-center">
			<div class="opt-body">
				...
				checkItem.getInspectionLevel()==null?"":(levelMap.containsKey(checkItem.getInspectionLevel())?levelMap.get(checkItem.getInspectionLevel()):checkItem.getInspectionLevel())adItemStrs}
									</div>
								</td>
							</tr>
		checkItem.getInspectionAmount()==null?"":checkItem.getInspectionAmount()pan="3" style="border-top:0px;">
