...
<script type="text/javascript" src="${resourcesCtx}/js/search.js"></script>
	<script type="text/javascript">
		...
		function $beforeEditRow(rowId,iRow,iCol,e){
			var isRight = false;
			<security:authorize ifAnyGranted="MFG_DEFECTION_CODE_SAVE">
			  isRight =  true;
			</security:authorize>
			return isRight;
		}
		...
		<div class="opt-body">
			<aa:zone name="main">
				...
				<security:authorize ifAnyGranted="MFG_DEFECTION_CODE_SAVE">
					...
					<security:authorize ifAnyGranted="MFG_DEFECTION_CODE_DELETE">
					...
					<security:authorize ifAnyGranted="MFG_DEFECTION_CODE_EXPORT">
					<button  class='btn' type="button" onclick="iMatrix.export_Data('${mfgctx}/base-info/defection-code/exportCode2.htm?defectionTypeId='+<%=defectionTypeId%>);"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</security:authorize>
				</div>
				<div id="opt-content">
					<form id="contentForm" method="post" action="" >
						<grid:jqGrid gridId="defectionCodeList" url="${mfgctx}/base-info/defection-code/list-datas.htm" code="MFG_DEFECTION_CODE"></grid:jqGrid>		
					</form>
				</div>
			</aa:zone>
		</div>
