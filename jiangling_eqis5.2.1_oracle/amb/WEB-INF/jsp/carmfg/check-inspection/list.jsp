	...
	<div class="ui-layout-center">
			<div class="opt-body">
				<aa:zone name="main">
					...
					<button class='btn' onclick="window.location='${mfgctx}/check-inspection/input.htm?workshop=${workshop}&inspectionPointId=${inspectionPointId}';" type="button"><span><span><b class="btn-icons btn-icons-add"></b>新建</span></span></button>
					</security:authorize>
					<security:authorize ifAnyGranted="check-inspection-delete">
					...
					<button  class='btn' onclick="export_Data('${mfgctx}/check-inspection/export.htm?workshop=${workshop}&workProcedure=${workProcedure}');" type="button"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
					</div>
					<div id="opt-content">
						<form id="contentForm" name="contentForm" method="post" action="">
							<grid:jqGrid gridId="dynamicInspection"  url="${mfgctx}/check-inspection/list-datas.htm?workshop=${workshop}&workProcedure=${workProcedure}" code="MFG_CHECK_INSPECTION_REPORT" pageName="page"></grid:jqGrid>
						</form>
						<script type="text/javascript">
							$(document).ready(function(){
								$("#dynamicInspection").jqGrid("setGridParam",{
									ondblClickRow:function(rowId){
										window.location='${mfgctx}/check-inspection/input.htm?workshop=${workshop}&inspectionPointId=${inspectionPointId}&id=' + rowId;
									}
								});
							});
						</script>
