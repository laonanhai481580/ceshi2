...
<head>
	...
	<script type="text/javascript">
		var params = ${params};
		params.inspectionDate_ge_datetime = params.inspectionDate + ' 00:00:00';
		params.inspectionDate_le_datetime = params.inspectionDate + ' 23:59:59';
		...
		function createDetailGrid(){
			...
			$("#detailTable").jqGrid({
				datatype: "json",
				url : '${mfgctx}/other-manu-analyse/regular-right-detail-datas.htm',
