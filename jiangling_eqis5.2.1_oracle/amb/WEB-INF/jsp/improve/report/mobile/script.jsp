...
var selectValue="",selectHiddenValue="";
	...
	function $img(inputId,picBoxId){
 	...
 	function saveForm() {
 		...
 		$("#applicationForm").attr("action","${supplierctx}/archives/supplier-cancle/save.htm");
 	...
 	function submitForm(){
 		...
 		$("#applicationForm").attr("action",'${supplierctx}/archives/supplier-cancle/submit-process.htm');
 		$("#applicationForm :input[name]").removeAttr("disabled");
 		$("#applicationForm").submit();
 	}
 	...
 	function _completeTask(taskTransact) {
 		...
 		$("#applicationForm :input[name]").removeAttr("disabled");
 		$("#applicationForm").attr("action","${supplierctx}/archives/supplier-cancle/complete-task.htm");
 		var validator = $("#applicationForm").data('validator');
 		if(validator){
 			validator.cancelSubmit = true;
 		}
	...
	//添加验证
 	...
 	function copyPersonCallBack(selectHiddenValue) {
 		...
 		$("#applicationForm").attr("action", "${supplierctx}/archives/supplier-cancle/copytask.htm?copyPerson=" + selectHiddenValue);
 		$("#applicationForm").ajaxSubmit(function(id) {
 			alert(id);
 		});
 	}
 	function assignUser(selectHiddenValue){
 		var url ="${supplierctx}/archives/supplier-cancle/assign.htm?assignee="+selectHiddenValue;
