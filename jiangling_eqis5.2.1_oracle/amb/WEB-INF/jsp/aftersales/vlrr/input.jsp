...
<%@ include file="style.jsp"%>
 ...
 <form id="applicationForm" name="applicationForm" method="post">
 	<input type="text" name="businessUnit" id="businessUnit" value="${businessUnit}"  />
	...
	<table class="all_tab">
		<tbody>
			<tr>
				...
				<td class="td_right">
					<input type="date" name="vlrrDate" id="vlrrDate" class="text-inp"  value="<s:date name='vlrrDate' format="yyyy-MM-dd"/>">
