		...
		<div class="opt-body">
			...
			<div id="opt-content">
				...
				<form id="contentForm" name="contentForm" method="post"  action="">
					<%-- <table class="form-table-without-border" style="width: 100%;margin-top: 10px;">
					<caption style="text-align:center;height: 35px"><h2>OBA明细表</h2></caption>
						<tr>
							<td style="width:20%">生产事业部：
								 <s:select list="businessUnits" 
									theme="simple"
									listKey="name" 
									listValue="value" 
