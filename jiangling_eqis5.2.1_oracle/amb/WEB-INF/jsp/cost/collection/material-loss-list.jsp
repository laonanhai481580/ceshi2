		...
		<aa:zone name="main">
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<input type="hidden" name="listCode" id="listCode" value="COST_MATERIAL_LOSS"></input>
					<input type="hidden" name="listName" id="listName" value="材料损失金额数据"></input>
					<input type="hidden" name="costType" id="costType" value="${costType}"></input>
					<grid:jqGrid gridId="list" url="${costctx}/collection/material-loss-list-datas.htm?costType=${costType}" code="COST_MATERIAL_LOSS"></grid:jqGrid>
				</form>
			</div>
		</aa:zone>
		</div>
