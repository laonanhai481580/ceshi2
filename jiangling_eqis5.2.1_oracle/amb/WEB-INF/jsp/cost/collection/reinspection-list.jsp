		...
		<aa:zone name="main">
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<input type="hidden" name="listCode" id="listCode" value="COST_REINSPECTION"></input>
					<input type="hidden" name="listName" id="listName" value="重检、拆解损失费用数据"></input>
					<input type="hidden" name="costType" id="costType" value="${costType}"></input>
					<grid:jqGrid gridId="list" url="${costctx}/collection/reinspection-list-datas.htm?costType=${costType}" code="COST_REINSPECTION"></grid:jqGrid>
				</form>
			</div>
		</aa:zone>
		</div>
