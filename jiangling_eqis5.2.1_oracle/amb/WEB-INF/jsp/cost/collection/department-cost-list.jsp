...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		...
		var thirdMenu="_department_cost";
	</script>
		...
		<aa:zone name="main">
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<input type="hidden" name="listCode" id="listCode" value="COST_DEPARTMENT_COST"></input>
					<input type="hidden" name="listName" id="listName" value="部门费用数据"></input>
					<input type="hidden" name="costType" id="costType" value="${costType}"></input>
					<grid:jqGrid gridId="list" url="${costctx}/collection/department-cost-list-datas.htm?costType=${costType}" code="COST_DEPARTMENT_COST"></grid:jqGrid>
				</form>
			</div>
		</aa:zone>
		</div>
