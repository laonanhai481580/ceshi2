		...
		<aa:zone name="main">
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<input type="hidden" name="listCode" id="listCode" value="COST_QA_PAY"></input>
					<input type="hidden" name="listName" id="listName" value="品保部薪酬数据"></input>
					<input type="hidden" name="costType" id="costType" value="${costType}"></input>
					<grid:jqGrid gridId="list" url="${costctx}/collection/qa-pay-list-datas.htm?costType=${costType}" code="COST_QA_PAY"></grid:jqGrid>
				</form>
			</div>
		</aa:zone>
		</div>
