		...
		<aa:zone name="main">
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<input type="hidden" name="listCode" id="listCode" value="COST_CUSTOMER_CLAIM"></input>
					<input type="hidden" name="listName" id="listName" value="客户索赔数据"></input>
					<input type="hidden" name="costType" id="costType" value="${costType}"></input>
					<grid:jqGrid gridId="list" url="${costctx}/collection/customer-claim-list-datas.htm?costType=${costType}" code="COST_CUSTOMER_CLAIM"></grid:jqGrid>
				</form>
			</div>
		</aa:zone>
		</div>
