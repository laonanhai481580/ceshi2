		...
		<aa:zone name="main">
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<input type="hidden" name="listCode" id="listCode" value="COST_QUALITY_COST"></input>
					<input type="hidden" name="listName" id="listName" value="质量处理费用数据"></input>
					<input type="hidden" name="costType" id="costType" value="${costType}"></input>
					<grid:jqGrid gridId="list" url="${costctx}/collection/quality-cost-list-datas.htm?costType=${costType}" code="COST_QUALITY_COST"></grid:jqGrid>
				</form>
			</div>
		</aa:zone>
		</div>
