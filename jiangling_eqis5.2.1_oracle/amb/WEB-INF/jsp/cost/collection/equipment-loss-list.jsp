		...
		<aa:zone name="main">
			...
			<div id="opt-content">
				<form id="contentForm" name="contentForm" method="post" action="">
					<input type="hidden" name="listCode" id="listCode" value="COST_EQUIPMENT_LOSS"></input>
					<input type="hidden" name="listName" id="listName" value="检测设备折旧金额数据"></input>
					<input type="hidden" name="costType" id="costType" value="${costType}"></input>
					<grid:jqGrid gridId="list" url="${costctx}/collection/equipment-loss-list-datas.htm?costType=${costType}" code="COST_EQUIPMENT_LOSS"></grid:jqGrid>
				</form>
			</div>
		</aa:zone>
		</div>
