...
<body onclick="$('#sysTableDiv').hide(); $('#styleList').hide();">
	<script type="text/javascript">
		...
		var thirdMenu="_composing_cost_record";
	</script>
				...
				<table cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<td valign="middle" style="padding: 0px;width:50%; margin: 0px;" id="btnTd">
							...
							<security:authorize ifAnyGranted="cost_cost_record_delete">
							...
							<security:authorize ifAnyGranted="cost_cost_record_export">
							<button class="btn" onclick="iMatrix.export_Data('${costctx}/cost-record/export.htm?sourceType=<%=CostRecord.SOURCE_TYPE_INPUT%>');"><span><span><b class="btn-icons btn-icons-export"></b>导出</span></span></button>
							</security:authorize>
						</td>
					</tr>
				</table>
