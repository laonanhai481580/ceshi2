...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			jQuery("#exteriorLossRateTrendDetailList").jqGrid({
				datatype: "json",
				jsonReader:{
					repeatitems:false
				},
				...
				autowidth:true,
				shrinkToFit:false,
				url:'${costctx}/statistical-analysis/exterior-loss-rate-trend-detail-list-datas.htm',
                colNames: colNames,
		        colModel: colModel,
//                 editurl: "${cargoctx}/inforshow/save.htm",
			...
			$("#exteriorLossRateTrendDetailList").jqGrid('setGroupHeaders', {
...
<input  type="hidden" id="colCode"  value="${colCode}"/>
	<div class="ui-layout-center">
		<div class="opt-body">
			...
			<div id="opt-content">
				<table style="width:100%;" id="exteriorLossRateTrendDetailList"></table>
				<div id="pager"></div>
			</div>
		</div>
	</div>
