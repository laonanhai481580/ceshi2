$.widget( "ui.CustomCombobox", {
	...
	_create: function() {
		...
		this.view = $("<div style='overflow:auto;display:none;'>")
		...
		if(this.view.css("display")=='block'){
			...
			if(!loaded){
				...
				this.view.html("数据加载中,请稍候... ...")
					.load(webRoot + "/mfg/common/product-bom-custom-combobox.htm?elementId=" + this.element.attr("id"),function(){
	...
	select : function(tableId,rowid){
		...
		if(data.id){
			...
			if($.isFunction(this.options.onSelect)){
				...
				this.options.onSelect.call(this,obj);
			}
		}
	},
