...
//					.css("background","blue")
			...
			function appendFiles(files){
				...
				for(var i=0;i<files.length;i++){
					var file = files[i];
					var FileListType="jpg,JPG,gif,GIF,jpeg,JPEG,png,PNG,txt,xls,xlsx,pdf,docx,dot,doc,pptx,zip,ZIP";
					...
					if(FileListType.indexOf(destStr) == -1){
						  alert("只允许上传jpg,JPG,gif,GIF,jpeg,JPEG,png,PNG,txt,xls,xlsx,pdf,docx,dot,doc,pptx,zip,ZIP文件");
						  return ;
					}
