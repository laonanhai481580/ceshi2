 ...
 */
@Entity
@Table(name = "AFS_VLRR_WARMING")//AFS_VLRR_WARMING
@JsonIgnoreProperties(value={"hibernateLazyInitializer","handler","fieldHandler"})
public class VlrrWarming extends IdEntity{
    
	private static final long serialVersionUID = 1L;
	private String workingProcedure;//新增字段  workingProcedure
	private Integer yearFen;// 新增字段  年份
	private String customerCode;//新增 字段 客户代码
	private String customerName;//客户名称
	private String ofilmModel;//欧菲机种
	private String model;//客户机种   新增
	private Integer years;//新增 字段  年度
