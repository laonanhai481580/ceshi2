 ...
 */
@Service
public class SupplierMrbCodeIntegrationService implements IntegrationService,Runnable{

private Logger log = Logger.getLogger(this.getClass());
	
	@Autowired
	private ProductBomDao bomDao;
	@Resource(name="oadbDataJdbcTemplate")
	...
	public void beginIntegration(Long companyId,String userLoginName){
		...
		try {
			//生成发料记录
			String tableName = "supplierMrbCode";
