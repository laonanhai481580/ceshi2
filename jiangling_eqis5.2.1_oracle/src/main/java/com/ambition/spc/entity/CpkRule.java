...
/**
 * 
 * 类名:CPK规则表(com.ambition.spc.entity)
 * <p>amb</p>
 * <p>厦门安必兴信息科技有限公司</p>
 * <p>功能说明：</p>
 * @author  陈伟伟
 ...
 */
@Entity
@Table(name = "SPC_CPK_RULE")
@JsonIgnoreProperties(value={"hibernateLazyInitializer","handler","fieldHandler"})//台账修改保存需要这句话
public class CpkRule extends IdEntity {
	private static final long serialVersionUID = 1L;
	/** FPA目标值(Service) */
	public static final String ENTITY_LIST_CODE = "SPC_CPK_RULE";//实体_列表_编码
