...
public static ArrayList JudgeAbnormalRealtime(double[] data, Abnormity[] abnormal, String[] dateTime, boolean[] dataJudgeState, double ucl, double lcl, double cl, Double tu, Double tl, String title, int upLow, int[] jump)
  {
    return JudgeAbnormal(data, abnormal, dateTime, dataJudgeState, 
      ucl, lcl, cl, tu, tl, title, upLow, jump);
  }

  @SuppressWarnings("rawtypes")
public static ArrayList JudgeAbnormal(double[] data, Abnormity[] abnormal, String[] dateTime, boolean[] dataJudgeState, double ucl, double lcl, double cl, Double tu, Double tl, String title, int upLow, int[] jump)
  {
    ...
    for (int i = 0; (abnormal != null) && (i < abnormal.length); i++) {
      ...
      case 1:
        retList = JudgeAbnormalUtil.BaseAbnormal1(data, abnormal[i], 
          dateTime, dataJudgeState, title, retList, upLow, jump);
      ...
      case 4:
        ...
        break;
      case 5:
        retList = JudgeAbnormalUtil.BaseAbnormal5(data, abnormal[i], 
          dateTime, dataJudgeState, ucl, lcl, cl, title, retList, upLow, jump);

        break;
      case 6:
        retList = JudgeAbnormalUtil.BaseAbnormal6(data, abnormal[i], 
          dateTime, dataJudgeState, ucl, lcl, cl, title, retList, upLow, jump);

        break;
      case 7:
        retList = JudgeAbnormalUtil.BaseAbnormal7(data, abnormal[i], 
          dateTime, dataJudgeState, ucl, lcl, cl, title, retList, upLow, jump);

        break;
      case 8:
        retList = JudgeAbnormalUtil.BaseAbnormal8(data, abnormal[i], 
          dateTime, dataJudgeState, ucl, lcl, title, retList, upLow, jump);

        break;
      case 9:
        retList = JudgeAbnormalUtil.BaseAbnormal9(data, abnormal[i], 
          dateTime, dataJudgeState, tu, tl, title, retList, upLow, jump);

        break;
      case 10:
        retList = JudgeAbnormalUtil.BaseAbnormal10(data, abnormal[i], 
          dateTime, dataJudgeState, ucl, lcl, cl, title, retList, upLow, jump);

        break;
      case 11:
        retList = JudgeAbnormalUtil.BaseAbnormal11(data, abnormal[i], 
          dateTime, dataJudgeState, ucl, lcl, cl, title, retList, upLow, jump);

        break;
      case 12:
        retList = JudgeAbnormalUtil.BaseAbnormal12(data, abnormal[i], 
          dateTime, dataJudgeState, cl, title, retList, upLow, jump);

        break;
      case 13:
        retList = JudgeAbnormalUtil.BaseAbnormal13(data, abnormal[i], 
          dateTime, dataJudgeState, ucl, lcl, cl, title, retList, upLow, jump);

        break;
      case 14:
        retList = JudgeAbnormalUtil.BaseAbnormal14(data, abnormal[i], 
          dateTime, dataJudgeState, ucl, lcl, cl, title, retList, upLow, jump);
      }
